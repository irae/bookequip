...
/**
 * LabEquipmentSchedule form base class.
 *
 * @method LabEquipmentSchedule getObject() Returns the current form's model object
 *
 * @package    BookEquip
 * @subpackage form
 ...
 */
abstract class BaseLabEquipmentScheduleForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lab_equipment_schedule[%s]');
