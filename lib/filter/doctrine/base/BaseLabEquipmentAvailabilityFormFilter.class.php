...
/**
 * LabEquipmentAvailability filter form base class.
 *
 * @package    BookEquip
 * @subpackage filter
 ...
 */
abstract class BaseLabEquipmentAvailabilityFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lab_equipment_availability_filters[%s]');
