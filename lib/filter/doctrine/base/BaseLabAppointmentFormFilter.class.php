...
abstract class BaseLabAppointmentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'event_status'     => new sfWidgetFormChoice(array('choices' => array('' => '', 'aprovado' => 'aprovado', 'pendente' => 'pendente', 'faturado' => 'faturado'))),
    ...
    $this->setValidators(array(
      ...
      'appointment_type' => new sfValidatorChoice(array('required' => false, 'choices' => array('básico' => 'básico', 'avançado' => 'avançado'))),
      'event_status'     => new sfValidatorChoice(array('required' => false, 'choices' => array('aprovado' => 'aprovado', 'pendente' => 'pendente', 'faturado' => 'faturado'))),
